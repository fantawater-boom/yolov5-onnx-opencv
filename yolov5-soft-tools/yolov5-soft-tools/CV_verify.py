...
if __name__ == "__main__":
    ...
    parser.add_argument("--source", default='ZK48.jpg', type=str, help="image path")
    parser.add_argument('--net_type', default='convert-onnx/best', choices=['yolov5s', 'yolov5l', 'yolov5m', 'yolov5x', 'best'])
